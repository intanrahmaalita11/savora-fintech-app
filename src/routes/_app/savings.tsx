...
import { Plus, Trash2, Minus, X, Loader2 } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <header className="flex items-center justify-between">
        <div>
          <h1 className="font-display text-2xl font-extrabold">Tabungan</h1>
          <p className="text-xs text-muted-foreground">Buat target & capai impianmu ✨</p>
        </div>
        <button
      ...
      {goals.length === 0 ? (
        <div className="card-soft flex flex-col items-center gap-3 p-8 text-center">
          ...
          <h3 className="text-base font-semibold">Belum ada target</h3>
          <p className="text-sm text-muted-foreground">Mulai dengan membuat target pertama kamu</p>
          <button
            onClick={() => setShowNew(true)}
            className="btn-press rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground"
          >
            Buat target
          </button>
        </div>
              ...
              <li key={g.id} className="card-soft p-5">
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="btn-press flex items-center justify-center gap-1.5 rounded-2xl bg-primary py-2.5 text-sm font-semibold text-primary-foreground"
                  >
